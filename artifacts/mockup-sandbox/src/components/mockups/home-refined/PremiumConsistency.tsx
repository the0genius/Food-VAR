...
const POPULAR_PRODUCTS = [
  { id: 1, name: "Almond Milk Unsweetened", brand: "Califia Farms", calories: 30, score: 92 },
  { id: 2, name: "Chicken Breast Grilled", brand: "Perdue", calories: 165, score: 85 },
  { id: 3, name: "Avocado Toast Mix", brand: "Trader Joe's", calories: 220, score: 78 },
];

export function PremiumConsistency() {
    ...
    <div className="min-h-screen bg-[#F6F8F7] font-['Inter'] flex flex-col pb-24 mx-auto w-full max-w-[390px] overflow-hidden">
      ...
      <div className="relative bg-gradient-to-b from-[#F0FAF4] to-[#F6F8F7] pt-14 pb-4">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-[rgba(0,0,0,0.04)]">
          <div 
            className="h-full bg-gradient-to-r from-[#3DD68C] to-[#2EC4B6] rounded-r-full" 
      ...
      <div className="flex-1 overflow-y-auto pt-6 px-5 space-y-[24px]">
        ...
        >
          <div className="p-5 flex flex-col h-full relative z-10">
            ...
            <button className="self-start rounded-full bg-gradient-to-r from-[#3DD68C] to-[#2E7D32] px-6 py-3 flex items-center gap-2 shadow-sm transform transition-transform active:scale-95">
          ...
          {/* Refined Graphic */}
          <div className="absolute top-1/2 -translate-y-1/2 right-[-20px] w-[140px] h-[140px] flex items-center justify-center">
            ...
            <Scan className="w-12 h-12 text-[#3DD68C] opacity-80 z-10" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <div className="flex items-end gap-1">
              ...
              <span className="text-[14px] font-[500] text-[#666666] mb-1">/100</span>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex items-end gap-1">
              ...
              <span className="text-[14px] font-[500] text-[#666666] mb-1">items</span>
            </div>
          </div>
        </div>

        {/* INSIGHT CARD - Tier 3 Depth (Quote style) */}
        <div 
          className="bg-white rounded-[20px] p-4 border border-[rgba(0,0,0,0.07)] pl-[20px] relative overflow-hidden"
        >
          {/* Subtle quote left accent via border trick or just padding */}
          <div className="flex items-start gap-3">
            <Lightbulb className="w-[14px] h-[14px] text-[#FB8C00] mt-[3px] shrink-0" />
            <p className="text-[14px] font-[500] text-[#666666] italic leading-snug">
        ...
        <div className="space-y-[12px]">
          <div className="flex items-center justify-between">
            ...
            <button className="text-[12px] font-[500] text-[#2E7D32] flex items-center">
          ...
          <div className="flex overflow-x-auto -mx-5 px-5 pb-4 gap-3 snap-x hide-scrollbar">
            {RECENT_SCANS.map((item) => {
              ...
              return (
                <div 
                  key={item.id}
                  className="bg-white rounded-[20px] w-[140px] shrink-0 snap-start border border-[rgba(0,0,0,0.07)] relative overflow-hidden flex flex-col"
                  style={{ boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}
                >
                  <div className="p-3 pb-4 flex-1 flex flex-col">
                    <div className="flex justify-between items-start mb-3">
                      <div className="w-[40px] h-[40px] rounded-[10px] bg-[#F6F8F7] flex items-center justify-center">
          ...
          <div className="space-y-2">
            {POPULAR_PRODUCTS.map((product) => {
              ...
              return (
                <div 
                  key={product.id}
                  className="bg-white rounded-[20px] p-3 border border-[rgba(0,0,0,0.07)] flex items-center gap-3"
                  style={{ boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}
                >
                  {/* Left-aligned score dot */}
                  <div className="w-[8px] h-[8px] rounded-full ml-1 shrink-0" style={{ backgroundColor: fg }} />
                  
                  <div className="w-[48px] h-[48px] rounded-[12px] bg-[#F6F8F7] flex items-center justify-center shrink-0 border border-[rgba(0,0,0,0.04)]">
                    <span className="text-[10px] font-bold text-[#999]">IMG</span>
                  </div>
        ...
        <div 
          className="rounded-[20px] p-5 border border-dashed flex flex-col items-center text-center mt-2"
          style={{ borderColor: "rgba(61, 214, 140, 0.4)", backgroundColor: "rgba(61, 214, 140, 0.02)" }}
        >
          <div className="w-[40px] h-[40px] rounded-full bg-[#E8F5E9] flex items-center justify-center mb-3">
            <Info className="w-5 h-5 text-[#2E7D32]" />
          </div>
          <h4 className="text-[14px] font-[600] text-[#1B1B1B] mb-1">
            Missing a product?
          </h4>
          <p className="text-[12px] font-[400] text-[#666666] mb-4 max-w-[200px]">
            Help improve our database by scanning unlisted items.
          </p>
          <button className="text-[12px] font-bold text-[#2E7D32] uppercase tracking-wide">
            Add Product
          </button>
        </div>
